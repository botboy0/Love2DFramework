...
- [ ] **DEV-01**: selene linting with `global_usage = "deny"` and custom std definition whitelisting only `love`, `world`, `eventBus`, `registry`
- [ ] **DEV-02**: stylua formatting enforced on all Lua source files
...
- [ ] **DEV-05**: busted test framework with ECS world setup/teardown lifecycle hooks
